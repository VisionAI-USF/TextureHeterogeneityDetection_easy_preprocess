...
if sizeDown(1)==32
    Fwavelet = 1-get_mask(1);
    %Fwavelet = 1 - createCirclesMask([32,32],[16,16],1);
end
if sizeDown(1)==16
    Fwavelet = 1-get_mask(1.5);
    %Fwavelet = 1 - createCirclesMask([32,32],[16,16],2);
end
if sizeDown(1)==8
    Fwavelet = 1-get_mask(2);
    %Fwavelet = 1 - createCirclesMask([32,32],[16,16],3);
end
